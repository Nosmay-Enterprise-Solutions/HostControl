...
@section('title', 'Batch N0.20250001983')
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list d-flex">
                            ...
                            <a href="#" class="btn btn-primary btn-5 d-none d-sm-inline-block" data-bs-toggle="modal"
                                data-bs-target="#modal-add" aria-label="Github" data-bs-toggle="tooltip"
                                data-bs-placement="bottom" data-bs-custom-class="apply-tooltip"
                                data-bs-title="New SKU Discount">
                                        ...
                                        <table class="table card-table table-vcenter datatable table-sm"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><button class="table-sort" data-sort="sort-progress">Driver</button></th>
                                                    <th><button class="table-sort" data-sort="sort-score">Location</button>
                                                    </th>
                                                    <th><button class="table-sort" data-sort="sort-date">Order Number</button>
                                                    </th>
                                                    <th><button class="table-sort" data-sort="sort-date">Amount deposited</button>
                                                    </th>
