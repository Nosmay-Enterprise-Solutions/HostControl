                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list d-flex">
                            ...
                            <a href="" class="btn btn-primary btn-5 d-none d-sm-inline-block"
                                data-bs-title="New SKU Discount" href="{{route('admin.finance.deposit-slip-view')}}">
                            ...
                            <a href="#" class="btn btn-primary btn-6 d-sm-none btn-icon"  href="{{route('admin.finance.deposit-slip-view')}}" aria-label="Create new report">
                                <!-- Download SVG icon from http://tabler.io/icons/icon/plus -->
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="icon icon-2">
                ...
                <div class="row row-deck row-cards">
                    ...
                    <div class="row justify-content-center m-2">
                            ...
                            <span class="d-sm-inline">
                                <div class="my-3">
                                    <div class="btn-group w-100" role="group">
                                        <div class="btn-group" role="group">
                                            <label for="btn-radio-dropdown-dropdown" class="btn dropdown-toggle"
                                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">User
                                                Type
                            ...
                            <span class="d-sm-inline">
                                <div class="my-3">
                                    <div class="btn-group w-100" role="group">
                                        <div class="btn-group" role="group">
                                            <label for="btn-radio-dropdown-dropdown" class="btn dropdown-toggle"
                                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pay
                                                Type
                        ...
                        <div class="col-auto align-self-center">
                            <div class="my-2">
                                <a href="#" class="btn btn-6 btn-success w-100 btn-icon" aria-label="Github"
                                    data-bs-toggle="tooltip" data-bs-placement="bottom"
                                    data-bs-custom-class="apply-tooltip" data-bs-title="Apply Filter">
                        ...
                        <div class="col-auto align-self-center">
                            <div class="my-2">
                                <a href="#" class="btn btn-6 btn-warning w-100 btn-icon" aria-label="Github"
                                    data-bs-toggle="tooltip" data-bs-placement="bottom"
                                    data-bs-custom-class="refresh-tooltip" data-bs-title="Reset Filter">
                                    <!-- Download SVG icon from http://tabler.io/icons/icon/brand-github -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <table class="table card-table table-vcenter datatable table-sm"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><button class="table-sort" data-sort="sort-progress">Order
                                                            Created</button></th>
                                                    <th><button class="table-sort ms-2" data-sort="sort-progress">Order
                                                            Status</button></th>
                                                    <th><button class="table-sort" data-sort="sort-score">Order
                                                            No.</button>
                                                    </th>
                                                    <th><button class="table-sort" data-sort="sort-date">Amount
                                                            Due</button>
                                                    </th>
                                                    <th><button class="table-sort" data-sort="sort-date">Amount
                                                            Paid</button>
                                                    </th>
                                                    <th><button class="table-sort ms-2" data-sort="sort-date">Payment
                                                            type</button>
                                                    </th>
                                                    <th><button class="table-sort" data-sort="sort-name">Variance</button>
                                                    </th>
                                                    <th><button class="table-sort"
                                                            data-sort="sort-progress">Warehouse</button></th>
                                            ...
                                            <tbody class="w-100">
                                                <tr>
                                                    ...
                                                    <td><span class="badge custom-badge success me-1">Delivered <svg
                                                    ...
                                                    <td class="sort-score"><a href="">VC-00028750</a></td>
                                                    <td class="sort-date" data-date="1730273409">GHS 2500</td>
                                                    <td class="sort-date" data-date="1730273409">GHS 2000</td>
                                                    <td><span class="badge custom-badge success">Cash <svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <td class="sort-date" data-date="1730273409">GHS 200</td>
                                                    <td class="sort-name">MT-VCMW</td>
                                                    <td><span class="badge custom-badge success me-1">Paid <svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                <tr>
                                                    <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                                            aria-label="Select invoice"></td>
                                                    <td class="sort-date" data-date="1730273409">01-Jan-2020</td>
                                                    <td><span class="badge custom-badge primary me-1">Picked
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <td class="sort-date" data-date="1730273409">GHS 2500</td>
                                                    <td class="sort-date" data-date="1730273409">GHS 2000</td>
                                                    <td><span class="badge custom-badge primary">Digital <svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <td><span class="badge custom-badge primary me-1">Banked <svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                <tr>
                                                    <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                                            aria-label="Select invoice"></td>
                                                    <td class="sort-date" data-date="1730273409">01-Jan-2020</td>
                                                    <td><span class="badge custom-badge secondary me-1">Delivering
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <td class="sort-date" data-date="1730273409">GHS 0.00</td>
                                                    <td class="sort-name">MT-VCMW</td>
                                                    <td><span class="badge custom-badge success me-1">Paid <svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sort-date" data-date="1730273409">GHS 2500</td>
                                                    <td class="sort-date" data-date="1730273409">GHS 2000</td>
                                                    <td><span class="badge custom-badge info">On Delivery <svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sort-date" data-date="1730273409">GHS 2500</td>
                                                    <td class="sort-date" data-date="1730273409">GHS 2000</td>
                                                    <td><span class="badge custom-badge orange">On Credit <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-credit-card">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center py-4">
                        ...
                        <div class="text-secondary">Do you really want to Deactivate<span class="text-danger fw-bold">
                                (40)</span> different Cash Reconciliation? This will make multiple changes at once.
                        </div>
                    </div>
                    <div class="modal-footer">
                        <div class="w-100">
