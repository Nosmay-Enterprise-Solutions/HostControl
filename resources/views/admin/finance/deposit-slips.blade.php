    ...
    <div class="page-wrapper">
                ...
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list d-flex">
                            ...
                            {{-- <a href="#" class="btn btn-primary btn-5 d-none d-sm-inline-block" href="{{route('admin.finance.deposit-slip-view')}}">
                    ...
                    <div class="page-body">
                                                    ...
                                                    <div class="btn-group w-100" role="group">
                                                        <div class="btn-group" role="group">
                                                            <label for="btn-radio-dropdown-dropdown"
                                                                ...
                                                                aria-haspopup="true" aria-expanded="false">Deposit Status
                                        ...
                                        <table class="table card-table table-vcenter datatable table-sm"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><button class="table-sort" data-sort="sort-progress">Date
                                                            Created</button></th>
                                                    <th><button class="table-sort" data-sort="sort-score">Batch
                                                            No.</button>
                                                    </th>
                                                    <th><button class="table-sort" data-sort="sort-date">Total
                                                            Amt.</button>
                                                    </th>
                                                    <th><button class="table-sort" data-sort="sort-date">Teller
                                                            No.</button>
                                                    </th>
                                                    <th><button class="table-sort" data-sort="sort-progress">Created
                                                            By</button></th>
                                                    <th><button class="table-sort ms-2" data-sort="sort-progress">Payment
                                                            Status</button>
                                                    <th><button class="table-sort" data-sort="sort-progress">Deposit
                                                            Status</button></th>

                                                    <th><button class="table-sort" data-sort="sort-progress">Last
                                                            Updated</button></th>
                                                    <th></th>
                                                </tr>
                                            </thead>
                                            <tbody class="w-100">
                                                <tr>
                                                    ...
                                                    <td class="sort-date" data-date="1730273409">01-Jan-2020</td>
                                                    <td class="sort-score"><a data-bs-toggle="offcanvas"
                                                            href="#offcanvasEnd" role="button"
                                                            aria-controls="offcanvasEnd">
                                                            BC-0002323
                                                        </a></td>
                                                    <td class="sort-date" data-date="1730273409">GHS 2500</td>
                                                    <td class="sort-date" data-date="1730273409">5</td>
                                                    <td class="sort-date" data-date="1730273409">Kumasi Bismark</td>
                                                    <td><span class="badge custom-badge info">Booked <svg
                                                    ...
                                                    <td><span class="badge custom-badge warning">Pending <svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end" style="">
                                                                ...
                                                                <a class="dropdown-item" href="#">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        ...
                                                                        stroke="currentColor" stroke-width="2"
                                                                        stroke-linecap="round" stroke-linejoin="round"
                                                                        class="icon icon-tabler icons-tabler-outline icon-tabler-circle-check me-2">
                                                                        <path stroke="none" d="M0 0h24v24H0z"
                                                                            fill="none" />
                                                                        <path
                                                                ...
                                                                <a class="dropdown-item border-top" href="#"
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        ...
                                                                        stroke="currentColor" stroke-width="2"
                                                                        stroke-linecap="round" stroke-linejoin="round"
                                                                        class="icon icon-tabler icons-tabler-outline icon-tabler-circle-dashed-check me-2 text-success">
                                                                        <path stroke="none" d="M0 0h24v24H0z"
                                                                            fill="none" />
                                                                ...
                                                                <a class="dropdown-item" href="#"
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        ...
                                                                        stroke="currentColor" stroke-width="2"
                                                                        stroke-linecap="round" stroke-linejoin="round"
                                                                        class="icon icon-tabler icons-tabler-outline icon-tabler-circle-x me-2 text-warning">
                                                                        <path stroke="none" d="M0 0h24v24H0z"
                                                                            fill="none" />
                                                                        <path
                                                                            d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sort-date" data-date="1730273409">5</td>
                                                    <td class="sort-date" data-date="1730273409">Kumasi Bismark</td>
                                                    <td><span class="badge custom-badge success me-1">Deposited <svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <td><span class="badge custom-badge success me-1">Verified <svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge custom-badge danger">Rejected<svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd"
                            ...
                            <div class="offcanvas-header">
                                <h2 class="offcanvas-title" id="offcanvasEndLabel">Batch No: <span
                                        class="text-orange">BC-2038024</span></h2>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="row small mb-1">
                                            <label class="col-sm-3 fw-light text-secondary">Created:</label>
                                            <div class="col-sm-9">
                                                13th November, 2024 13:48:24
                                            </div>
                                        </div>
                                        <div class="row small mb-1">
                                            <label class="col-sm-3 fw-light text-secondary">Updated:</label>
                                            <div class="col-sm-9">
                                                13th November, 2024 14:50:16
                                            </div>
                                        </div>
                                        <div class="row small mb-1">
                                            <label class="col-sm-3 fw-light text-secondary">Amount:</label>
                                            <div class="col-sm-9">
                                                GH₵42,915.00
                                            </div>
                                        </div>
                                        <div class="row small mb-1">
                                            <label class="col-sm-3 fw-light text-secondary">Teller:</label>
                                            <div class="col-sm-9 ">
                                                2
                                            </div>
                                        </div>
                                        <div class="row small mb-1">
                                            <label class="col-sm-3 fw-light text-secondary">Created By:</label>
                                            <div class="col-sm-9">
                                                Log Johnson
                                            </div>
                                        </div>
                                        <div class="row small mb-2">
                                            <label class="col-sm-3 fw-light text-secondary">Cash Status:</label>
                                            <div class="col-sm-9">
                                                <span class="badge custom-badge success">Deposited</span>
                                            </div>
                                        </div>
                                        <div class="row small mb-1">
                                            <label class="col-sm-3 fw-light text-secondary">Remarks:</label>
                                            <div class="col-sm-9">
                                                Balance was deposited via MoMo Pos
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table card-table table-vcenter datatable table-sm"
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><button class="table-sort" data-sort="sort-progress">Order
                                                            No.</button></th>
                                                    <th><button class="table-sort" data-sort="sort-score">Amount
                                                            Due</button>
                                                    </th>
                                                    <th><button class="table-sort"
                                                            data-sort="sort-date">Collected</button>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody class="w-100">
                                                <tr>
                                                    <td class="sort-score"><a
                                                            href="{{ route('admin.orders.all-orders') }}" target="_blank">
                                                            VC-00023990
                                                        </a></td>
                                                    <td class="sort-date">GH₵2560.00</td>
                                                    <td class="sort-date">GH₵2560.00</td>
                                                </tr>
                            ...
                            <div class="offcanvas-footer">
                                <a class="btn btn-primary" href="{{route('admin.finance.deposit-slip-view')}}"  type="button">
                                    Expand
                                </a>
                            </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add to Deposit Slip</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 ms-3">
                                        ...
                                        <label class="form-check form-switch form-switch-2">
                                            ...
                                            <span class="form-check-label">Active / Inactive</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label class="form-label">SKU Discount name</label>
                                        ...
                                        <label class="form-selectgroup-item">
                                            ...
                                            <span class="form-selectgroup-label d-flex align-items-center p-3">
                                                ...
                                                <span class="form-selectgroup-label-content">
                                                    <span class="form-selectgroup-title strong mb-1">Flat Rate</span>
                                                    <span class="d-block text-secondary">Applies a fixed discount amount
                                                        to
                                                        the total price, regardless of the order value.</span>
                                                </span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-lg-6">
                                        <label class="form-selectgroup-item">
                                            ...
                                            <span class="form-selectgroup-label d-flex align-items-center p-3">
                                                ...
                                                <span class="form-selectgroup-label-content">
                                                    <span class="form-selectgroup-title strong mb-1">Percentage</span>
                                                    <span class="d-block text-secondary">Applies a percentage-based
                                                        discount, calculating the reduction based on the total price.</span>
                                                </span>
                                            </span>
                                        </label>
                                    </div>
        ...
        <div class="modal modal-blur fade" id="modal-edit" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">View SKU Discount</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
        ...
        <!-- Bulk Actions Discount Type Modal -->
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="#" class="btn btn-primary btn-5 ms-auto" data-bs-toggle="modal"
                            data-bs-target="#modal-verify">
                            <!-- Download SVG icon from http://tabler.io/icons/icon/plus -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" class="icon icon-2">
        ...
        <!-- Bulk Verify Modal -->
        <div class="modal modal-blur fade" id="modal-verify" tabindex="-1" style="display: none;"
            aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                <div class="modal-content">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    ...
                    <div class="modal-body text-center py-4">
                        ...
                        <div class="text-secondary">Are you sure you want to apply this bulk update? This will affect
                            multiple records but can be undone if needed.</div>
                    </div>
                    <div class="modal-footer">
                        <div class="w-100">
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="#" class="btn btn-dark btn-4 w-100" data-bs-dismiss="modal">
                                        Update
                                    </a>
                                </div>
                            </div>
        ...
        <!-- Bulk Actions Delete / Disable Modal -->
        <div class="modal modal-blur fade" id="modal-danger-bulk" tabindex="-1" aria-hidden="true"
            style="display: none;">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                <div class="modal-content">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    ...
                    <div class="modal-body text-center py-4">
                        ...
                        <h3>Are you sure?</h3>
                        <div class="text-secondary">Do you really want to Deactivate<span class="text-danger fw-bold">
                                (40)</span> different Deposit Slips? This will make multiple changes at once.
                        </div>
                    </div>
                    <div class="modal-footer">
                        <div class="w-100">
