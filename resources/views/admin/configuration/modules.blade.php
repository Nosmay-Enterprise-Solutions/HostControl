                                        ...
                                        <table class="table card-table table-vcenter datatable table-sm"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <button class="table-sort" data-sort="sort-city">Name</button>
                                                    </th>
                                                    <th>
                                                        Description
                                                    </th>
                                            ...
                                            <tbody class="w-100">
                                                ...
                                                @forelse ($modules as $module)
                                                    <tr>
                                                        ...
                                                        <td class="sort-date" data-date="1730273409">{{ $module->name }}
                                                        </td>
                                                        <td class="sort-quantity">{{ $module->description }}</td>
                                                        <td class="sort-quantity">
                                                            @if ($module->state == 1)
                                                                <span class="badge bg-green text-green-fg">On</span>
                                                            @elseif ($module->state == 0)
                                                                <span class="badge bg-red text-red-fg">Off</span>
                                                            @endif
                                                        </td>
                                                        <td class="text-end">
                                                            <span class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    @if($module->state == 0)
                                                                    <a class="dropdown-item text-green" aria-label="Turn On" href="{{route('admin.configuration.modules.change-state', [$module->code, 'true', 'turn-on'])}}">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            width="24" height="24"
                                                                            viewBox="0 0 24 24" fill="none"
                                                                            stroke="currentColor" stroke-width="2"
                                                                            stroke-linecap="round" stroke-linejoin="round"
                                                                            class="icon icon-tabler icons-tabler-outline icon-tabler-square-rounded-check me-2">
                                                                    ...
                                                                    <a class="dropdown-item text-red" href="{{route('admin.configuration.modules.change-state', [$module->code, 'false', 'turn-off'])}}">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            width="24" height="24"
                                                                            viewBox="0 0 24 24" fill="none"
                                                                            stroke="currentColor" stroke-width="2"
                                                                            stroke-linecap="round" stroke-linejoin="round"
                                                                            class="icon icon-tabler icons-tabler-outline icon-tabler-square-rounded-x me-2">
                                                                            <path stroke="none" d="M0 0h24v24H0z"
                                                                                fill="none" />
