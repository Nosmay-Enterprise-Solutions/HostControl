...
@section('title', 'All Bundled Services')
    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('admin-onetime-service-add') }}" class="btn btn-primary d-none d-sm-inline-block">
                    ...
                    <a href="{{ route('admin-onetime-service-add') }}" class="btn btn-primary d-sm-none btn-icon"
                        ...
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin-onetime-service-view') }}" class="text-reset"
                                            tabindex="-1">SAP Business One</a></td>
                                    <td><span>GHC </span>0.00
                                    </td>
                                    <td>
                                        20
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex justify-content-ecenter gap-2">
                                            <!-- View Action -->
                                            <a href="{{ route('admin-onetime-service-view') }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center py-4">
                        ...
                        <div class="alert alert-danger text-danger" role="alert">
                            Cannot delete service plan. It's being used in an active or pending service.
                        </div>
                    </div>
