                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table card-table table-vcenter datatable table-sm" style=" overflow-y: auto; max-height: 60vh;">
                                            <thead>
                                                <tr>
                                                    <th class="w-1"><input class="form-check-input m-0 align-middle"
                                                            type="checkbox" aria-label="Select all invoices"></th>
                                                    <th><button class="table-sort" data-sort="sort-name">Created
                                                            on</button></th>
                                                    <th><button class="table-sort" data-sort="sort-city">Order
                                                            No.</button>
                                                    </th>
                                                    <th><button class="table-sort" data-sort="sort-type">Weight</button>
                                                    </th>
                                                    <th><button class="table-sort"
                                                            data-sort="sort-score">Customer</button>
                                                    </th>
                                                    <th><button class="table-sort" data-sort="sort-date">Location</button>
                                                    </th>
                                                    <th><button class="table-sort" data-sort="sort-quantity">Delivery
                                                            Date</button></th>
                                                    <th><button class="table-sort"
                                                            data-sort="sort-progress">Status</button>
                                                    </th>
                                                    <th><button class="table-sort" data-sort="sort-progress">Payment
                                                            Status</button></th>
                                                    <th><button class="table-sort" data-sort="sort-progress">Whse
                                                            ID</button></th>
                                            ...
                                            <tbody class="w-100">
                                                <tr>
                                                    ...
                                                    <td class="sort-name">01-Jan-2024</td>
                                                    <td class="sort-city text-warning">VC-00026769</td>
                                                    <td class="sort-type">25.00kg</td>
                                                    <td class="sort-score">Mr. Henry Adobeaboni Maddow</td>
                                                    <td class="sort-date" data-date="1730273409">Osu</td>
                                                    <td class="sort-quantity">01-Jan-2024</td>
                                                    <td><span class="badge bg-warning me-1"></span>Pending</td>
                                                    <td><span class="badge bg-success me-1"></span>Paid</td>
                                                    <td class="sort-quantity">MT-VCMW</td>
                                                    <td class="sort-quantity">01-Jan-2024</td>
                                                    <td class="text-end">
                                                        <span class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end" style="">
                                                                ...
                                                                <a class="dropdown-item" href="#">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        ...
                                                                        stroke="currentColor" stroke-width="2"
                                                                        stroke-linecap="round" stroke-linejoin="round"
                                                                        class="icon icon-tabler icons-tabler-outline icon-tabler-invoice me-2">
                                                                        <path stroke="none" d="M0 0h24v24H0z"
                                                                            fill="none" />
                                                                ...
                                                                <a class="dropdown-item" href="#">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        ...
                                                                        stroke="currentColor" stroke-width="2"
                                                                        stroke-linecap="round" stroke-linejoin="round"
                                                                        class="icon icon-tabler icons-tabler-outline icon-tabler-receipt me-2">
                                                                        <path stroke="none" d="M0 0h24v24H0z"
                                                                            fill="none" />
                                                                        <path
                                                                ...
                                                                <a class="dropdown-item" href="#">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        ...
                                                                        stroke="currentColor" stroke-width="2"
                                                                        stroke-linecap="round" stroke-linejoin="round"
                                                                        class="icon icon-tabler icons-tabler-outline icon-tabler-credit-card-refund me-2">
                                                                        <path stroke="none" d="M0 0h24v24H0z"
                                                                            fill="none" />
                                                                        <path
                                                ...
                                                <tr>
                                                    <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                                            aria-label="Select invoice"></td>
                                                    <td class="sort-name">01-Jan-2024</td>
                                                    <td class="sort-city text-warning"><span class=""
                                                            href="./">VC-00026769</span></td>
                                                    <td class="sort-type">25.00kg</td>
                                                    <td class="sort-score">Mr. Maddow</td>
                                                    <td class="sort-date" data-date="1730273409">Osu</td>
                                                    <td class="sort-quantity">01-Jan-2024</td>
                                                    <td><span class="badge bg-warning me-1"></span>Pending</td>
                                                    <td><span class="badge bg-success me-1"></span>Paid</td>
