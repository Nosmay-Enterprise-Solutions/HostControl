                                    ...
                                    <div class="card-body">
                                        <div class="">
                                            ...
                                            <div class="badges-list my-3">
                                                ...
                                                <div class="custom-link col-sm-6 col-md-2 ">
                                                    <a href="{{ route('admin.administration.roles') }}" title="Roles">
                                                        <span class="button-title"><svg xmlns="http://www.w3.org/2000/svg"
                                                                width="24" height="24" viewBox="0 0 24 24"
                                                                fill="none" stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="icon icon-tabler icons-tabler-outline icon-tabler-user-cog me-1">
                                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                ...
                                                <div class="custom-link col-sm-6 col-md-2 ">
                                                    <a href="{{ route('admin.administration.partners') }}" title="Partners">
                                                        <span class="button-title"><svg xmlns="http://www.w3.org/2000/svg"
                                                                width="24" height="24" viewBox="0 0 24 24"
                                                                fill="none" stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="icon icon-tabler icons-tabler-outline icon-tabler-a-b-2 me-1">
                                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                                <path
                                                ...
                                                <div class="custom-link col-sm-6 col-md-2 ">
                                                    <a href="{{ route('admin.administration.locations') }}"
                                                        ...
                                                        <span class="button-title"><svg xmlns="http://www.w3.org/2000/svg"
                                                                ...
                                                                fill="none" stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="icon icon-tabler icons-tabler-outline icon-tabler-world-pin me-1">
                                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                ...
                                                <div class="custom-link col-sm-6 col-md-2 ">
                                                    <a href="" title="API Keys">
                                                        <span class="button-title"><svg xmlns="http://www.w3.org/2000/svg"
                                                                width="24" height="24" viewBox="0 0 24 24"
                                                                fill="none" stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="icon icon-tabler icons-tabler-outline icon-tabler-sitemap me-1">
                                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                                <path
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="badges-list my-3">
                                            ...
                                            <div class="custom-link col-sm-6 col-md-2 ">
                                                <a href="" title="Roles">
                                                    <span class="button-title">Roles</span>
                                                </a>
                                            </div>
                                            <div class="custom-link col-sm-6 col-md-2 ">
                                                <a href="" title="Partners">
                                                    <span class="button-title">Partners</span>
                                                </a>
                                            </div>
                                            <div class="custom-link col-sm-6 col-md-2 ">
                                            ...
                                            <div class="custom-link col-sm-6 col-md-2 ">
                                                <a href="" title="API Keys">
                                                    <span class="button-title">API Keys</span>
                                                </a>
                                            </div>
                                            <div class="custom-link col-sm-6 col-md-2 ">
