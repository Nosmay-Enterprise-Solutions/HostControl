                ...
                <div class="col-12">
                    <form class="card" method="post" novalidate>@csrf
                        <div class="card-header">
                            <h3 class="card-title">Lead's Basic Info</h3>
                        </div>
                        <div class="card-body  mx-4 justify-content-end">
                            <div class="mb-3 row">
                                <label class="col-3 col-form-label" for="portal-login">Portal Login</label>
                                <div class="col">
                                    <input type="email" class="form-control" placeholder="Enter portal login email/number"
                                        id="portal-login" name="portal_login" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-3 col-form-label" for="portal-password">Portal Password</label>
                                <div class="col">
                                    <input type="password" class="form-control" placeholder="Password" id="portal-password"
                                        name="portal_password" required>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control" placeholder="Enter companey names"
                                        name="company_name" id="company-name" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row" style="display: none;">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control" placeholder="Enter Other Names"
                                        name="other_names" id="other-names" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col">
                                    <input type="email" class="form-control" placeholder="Enter billing email"
                                        name="billing_email" id="billing-email" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col">
                                    <input type="text" name="phonenumber" class="form-control"
                                        data-mask="+000(0)000000000" data-mask-visible="true"
                                        placeholder="+000(0)000000000" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="mb-3 row" style="display: none;">
                                ...
                                <div class="col">
                                    <input type="date" class="form-control" placeholder="DD/MM/YYY"
                                        name="date_of_birth" id="date-of-birth" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col">
                                    <input type="date" class="form-control" placeholder="DD/MM/YYY"
                                        name="registration_date" id="registration-date" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response && response && Array.isArray(response)) {
                            ...
                            console.error('Invalid locations data:', response ? response :
