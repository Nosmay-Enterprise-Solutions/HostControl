    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            <div class="text-center mb-4">
                <a href="." class="navbar-brand navbar-brand-autodark"><img src="{{ asset('bank/logo/logo.svg') }}" height="36"
                        alt=""></a>
            </div>
            <form class="card card-md" action="./" method="get" autocomplete="off" novalidate>
                <div class="card-body">
                    ...
                    <div class="mb-3 text-center">
                        ...
                        <input type="email" class="form-control  text-center" placeholder="Enter email" autocomplete="off">
                    </div>
