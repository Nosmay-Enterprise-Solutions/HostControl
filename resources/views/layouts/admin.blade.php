...
<head>
    ...
    <title>@yield('title') - HostControl | Nosmay Enterprise Solutions</title>
    <!-- CSS files -->
...
<body>
    <script src="bank/js/demo-theme.min.js"></script>
    <div class="page">
        <!-- Sidebar -->
        <aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
            <div class="container-fluid">
                ...
                <h1 class="navbar-brand navbar-brand-autodark">
                    <a href=".">
                        <img src="{{asset('bank/logo/logo-white.svg')}}" width="110" height="32" alt="Tabler"
                ...
                <div class="navbar-nav flex-row d-lg-none">
                    ...
                    @include('layouts.branches.user')
                </div>
                @include('layouts.branches.nav')
            </div>
        </aside>
        <!-- Navbar -->
        <header class="navbar navbar-expand-md navbar-light d-none d-lg-flex d-print-none">
            <div class="container-xl">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    @include('layouts.branches.search')
                </div>
            </div>
        </header>
        <div class="page-wrapper">
           ...
           @include('layouts.branches.footer')
        </div>
    </div>

    <!-- Libs JS -->
    <script src="{{ asset('bank/libs/apexcharts/dist/apexcharts.min.js') }}" defer></script>
    <script src="{{ asset('bank/libs/jsvectormap/dist/js/jsvectormap.min.js') }}" defer></script>
    <script src="{{ asset('bank/libs/jsvectormap/dist/maps/world.js') }}" defer></script>
    <script src="{{ asset('bank/libs/jsvectormap/dist/maps/world-merc.js') }}" defer></script>
    <!-- Tabler Core -->
