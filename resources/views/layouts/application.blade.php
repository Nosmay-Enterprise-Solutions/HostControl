        ...
        <div class="container container-tight py-4">
            ...
            <div class="card card-md">
                <div class="card-body text-center py-4 p-sm-5">
                    <img src="./static/illustrations/undraw_sign_in_e6hj.svg" height="120" class="mb-n2"
                        alt="">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="form-hint">Choose a URL that describes you or your business in a concise way. Make
                            it short and easy to remember so you can share links with ease.</div>
                    </div>
                    <div>
                        ...
                        <select class="form-select mb-0">
                            ...
                            <option value="CEDT" selected>(UTC+01:00) Belgrade, Bratislava, Budapest, Ljubljana,
                                Prague</option>
