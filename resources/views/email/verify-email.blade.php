                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="center" valign="top" style="padding: 36px 24px;">
                            <a href="https://nosmay.com" target="_blank" style="display: inline-block;">
                                <img src="https://hc.nosmay.com/bank/logo/logo.png" alt="Logo" border="0" width="150"
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Cheers,<br> Nosmay Enterprise</p>
                        </td>
                    </tr>
                    <!-- end copy -->
        ...
        <![endif]-->
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="center" bgcolor="#e9ecef"
                            style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                            <p style="margin: 0; font-weight: bold">Nosmay Enterprise</p>
                            <p style="margin: 0;">Harnessing Knowledge. Get all your technology solutions from ERPs, SMEs, CRMs to Website Designing at the best prices.</p>
                        </td>
                    </tr>
                    <!-- end unsubscribe -->
